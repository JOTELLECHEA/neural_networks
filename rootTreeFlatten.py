...
#############################################################################
    ...
    ######################################################################################
        ...
        if jet > 0: 
            jet1pT[0]  = event.jetpT[0]
            jet1eta[0] = event.jeteta[0]
            jet1phi[0] = event.jetphi[0]
            jet1b[0]   = event.jetbhadron[0]
            jet1c[0]   = event.jetchadron[0]
            if jet >1:
                jet2pT[0]  = event.jetpT[1]
                jet2eta[0] = event.jeteta[1]
                jet2phi[0] = event.jetphi[1]
                jet2b[0]   = event.jetbhadron[1]
                jet2c[0]   = event.jetchadron[1]
                if jet > 2:
                    jet3pT[0]  = event.jetpT[2]
                    jet3eta[0] = event.jeteta[2]
                    jet3phi[0] = event.jetphi[2]
                    jet3b[0]   = event.jetbhadron[2]
                    jet3c[0]   = event.jetchadron[2]
                    if jet > 3: 
                        jet4pT[0]  = event.jetpT[3]
                        jet4eta[0] = event.jeteta[3]
                        jet4phi[0] = event.jetphi[3]
                        jet4b[0]   = event.jetbhadron[3]
                        jet4c[0]   = event.jetchadron[3]
                        if jet >4:
                            jet5pT[0]  = event.jetpT[4]
                            jet5eta[0] = event.jeteta[4]
                            jet5phi[0] = event.jetphi[4]
                            jet5b[0]   = event.jetbhadron[4]
                            jet5c[0]   = event.jetchadron[4]
                            if jet > 5:
                                jet6pT[0]  = event.jetpT[5]
                                jet6eta[0] = event.jeteta[5]
                                jet6phi[0] = event.jetphi[5]
                                jet6b[0]   = event.jetbhadron[5]
                                jet6c[0]   = event.jetchadron[5]
                                if jet > 6: 
                                    jet7pT[0]  = event.jetpT[6]
                                    jet7eta[0] = event.jeteta[6]
                                    jet7phi[0] = event.jetphi[6]
                                    jet7b[0]   = event.jetbhadron[6]
                                    jet7c[0]   = event.jetchadron[6]
                                    if jet >7:
                                        jet8pT[0]  = event.jetpT[7]
                                        jet8eta[0] = event.jeteta[7]
                                        jet8phi[0] = event.jetphi[7]
                                        jet8b[0]   = event.jetbhadron[7]
                                        jet8c[0]   = event.jetchadron[7]
                                        if jet > 8:
                                            jet9pT[0]  = event.jetpT[8]
                                            jet9eta[0] = event.jeteta[8]
                                            jet9phi[0] = event.jetphi[8]
                                            jet9b[0]   = event.jetbhadron[8]
                                            jet9c[0]   = event.jetchadron[8]
                                            if jet > 9 :
                                                jet10pT[0]  = event.jetpT[9]
                                                jet10eta[0] = event.jeteta[9]
                                                jet10phi[0] = event.jetphi[9]
                                                jet10b[0]   = event.jetbhadron[9]
                                                jet10c[0]   = event.jetchadron[9]
                                                if jet > 10:
                                                    jet11pT[0]  = event.jetpT[10]
                                                    jet11eta[0] = event.jeteta[10]
                                                    jet11phi[0] = event.jetphi[10]
                                                    jet11b[0]   = event.jetbhadron[10]
                                                    jet11c[0]   = event.jetchadron[10]
                                                    if jet > 11:
                                                        jet12pT[0]  = event.jetpT[11]
                                                        jet12eta[0] = event.jeteta[11]
                                                        jet12phi[0] = event.jetphi[11]
                                                        jet12b[0]   = event.jetbhadron[11]
                                                        jet12c[0]   = event.jetchadron[11]
                                                        if jet >12:
                                                            jet13pT[0]  = event.jetpT[12]
                                                            jet13eta[0] = event.jeteta[12]
                                                            jet13phi[0] = event.jetphi[12]
                                                            jet13b[0]   = event.jetbhadron[12]
                                                            jet13c[0]   = event.jetchadron[12]
                                                            if jet > 13:
                                                                jet14pT[0]  = event.jetpT[13]
                                                                jet14eta[0] = event.jeteta[13]
                                                                jet14phi[0] = event.jetphi[13]
                                                                jet14b[0]   = event.jetbhadron[13]
                                                                jet14c[0]   = event.jetchadron[13]
                                                                if jet > 14:
                                                                    jet15pT[0]  = event.jetpT[14]
                                                                    jet15eta[0] = event.jeteta[14]
                                                                    jet15phi[0] = event.jetphi[14]
                                                                    jet15b[0]   = event.jetbhadron[14]
                                                                    jet15c[0]   = event.jetchadron[14]
                                                                    if jet > 15:
                                                                        jet16pT[0]  = event.jetpT[15]
                                                                        jet16eta[0] = event.jeteta[15]
                                                                        jet16phi[0] = event.jetphi[15]
                                                                        jet16b[0]   = event.jetbhadron[15]
                                                                        jet16c[0]   = event.jetchadron[15]
                                                                        if jet >16:
                                                                            jet17pT[0]  = event.jetpT[16]
                                                                            jet17eta[0] = event.jeteta[16]
                                                                            jet17phi[0] = event.jetphi[16]
                                                                            jet17b[0]   = event.jetbhadron[16]
                                                                            jet17c[0]   = event.jetchadron[16]
                                                                            if jet > 17:
                                                                                jet18pT[0]  = event.jetpT[17]
                                                                                jet18eta[0] = event.jeteta[17]
                                                                                jet18phi[0] = event.jetphi[17]
                                                                                jet18b[0]   = event.jetbhadron[17]
                                                                                jet18c[0]   = event.jetchadron[17]
                                                                                if jet > 18:
                                                                                    jet19pT[0]  = event.jetpT[18]
                                                                                    jet19eta[0] = event.jeteta[18]
                                                                                    jet19phi[0] = event.jetphi[18]
                                                                                    jet19b[0]   = event.jetbhadron[18]
                                                                                    jet19c[0]   = event.jetchadron[18]
                                                                                    if jet > 19:
                                                                                        jet20pT[0]  = event.jetpT[19]
                                                                                        jet20eta[0] = event.jeteta[19]
                                                                                        jet20phi[0] = event.jetphi[19]
                                                                                        jet20b[0]   = event.jetbhadron[19]
                                                                                        jet20c[0]   = event.jetchadron[19]
                                                                                        if jet > 20:
                                                                                            jet21pT[0]  = event.jetpT[20]
                                                                                            jet21eta[0] = event.jeteta[20]
                                                                                            jet21phi[0] = event.jetphi[20]
                                                                                            jet21b[0]   = event.jetbhadron[20]
                                                                                            jet21c[0]   = event.jetchadron[20]
                                                                                        else:
                                                                                            jet21pT[0]  = -999
                                                                                            jet21eta[0] = -9
                                                                                            jet21phi[0] = -9
