...
j10 = ROOT.TH1D('jet10pT','jet10pT;Jet1 pT;Events normalised to unit area',1800,0,1800)
j11 = ROOT.TH1D('jet11pT','jet11pT;Jet1 pT;Events normalised to unit area',1800,0,1800)
j12 = ROOT.TH1D('jet12pT','jet12pT;Jet1 pT;Events normalised to unit area',1800,0,1800)
j13 = ROOT.TH1D('jet13pT','jet13pT;Jet1 pT;Events normalised to unit area',1000,0,1000)
j14 = ROOT.TH1D('jet14pT','jet14pT;Jet1 pT;Events normalised to unit area',1000,0,1000)
j15 = ROOT.TH1D('jet15pT','jet15pT;Jet1 pT;Events normalised to unit area',1000,0,1000)
j16 = ROOT.TH1D('jet16pT','jet16pT;Jet1 pT;Events normalised to unit area',800,0,800)
j17 = ROOT.TH1D('jet17pT','jet17pT;Jet1 pT;Events normalised to unit area',800,0,800)
j18 = ROOT.TH1D('jet18pT','jet18pT;Jet1 pT;Events normalised to unit area',800,0,800)
j19 = ROOT.TH1D('jet19pT','jet19pT;Jet1 pT;Events normalised to unit area',200,0,200)
j20 = ROOT.TH1D('jet20pT','jet20pT;Jet1 pT;Events normalised to unit area',200,0,200)
j21 = ROOT.TH1D('jet21pT','jet21pT;Jet1 pT;Events normalised to unit area',200,0,200)
